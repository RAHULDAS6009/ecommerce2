                ...
                <div className="social-search-area text-center">
                  <div className="social-icon socile-icon-style-2">
                    <ul>
                      ...
                      <li><a href="#" title="dribble"><i className="fa fa-dribbble" /></a></li>
                      <li><a href="#" title="behance"><i className="fa fa-behance" /></a></li>
                      <li><a href="#" title="rss"><i className="fa fa-rss" /></a></li>
                    </ul>
                  </div>
                </div>
              </div>
                    ...
                    <li>
                      <div className="header-cart">
                        <div className="cart-icon">
                          <a href="#">
                            Cart<i className="zmdi zmdi-shopping-cart" />
                          </a>
                          <span>2</span>
                        </div>
                        <div className="cart-content-wraper">
                          <div className="cart-single-wraper">
                            <div className="cart-img">
                              <a href="#"><img src="images/product/01.jpg" alt="Product 01" /></a>
                            </div>
                            ...
                            <div className="remove"><a href="#"><i className="zmdi zmdi-close" /></a></div>
                          </div>

                          <div className="cart-single-wraper">
                            <div className="cart-img">
                              <a href="#"><img src="images/product/02.jpg" alt="Product 02" /></a>
                            </div>
                            <div className="cart-content">
                              <div className="cart-name"><a href="#">Aenean Eu Tristique</a></div>
                              <div className="cart-price">$70.00</div>
                    ...
                    <ul className="main-menu">
                        ...
                        <div className="mega-menu-area mma-800">
                          ...
                          <div className="mega-banner-img">
                            <a href="single-product.html">
                              <img src="images/banner/banner-fashion-02.jpg" alt="banner" />
                            </a>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className="mega-parent pos-rltv">
                        ...
                        <div className="mega-menu-area mma-700">
                          ...
                          <div className="mega-banner-img">
                            <a href="single-product.html">
                              <img src="images/banner/banner-fashion.jpg" alt="banner" />
                            </a>
                          </div>
                        </div>
                      </li>
                      ...
                      <div className="global-cell">
                        <form action="#">
                          <div className="input-box">
                            <input className="single-input" placeholder="Search anything" type="text" />
                            <button className="src-btn" type="button"><i className="fa fa-search" /></button>
                          </div>
                        </form>
                      </div>
                    </div>
